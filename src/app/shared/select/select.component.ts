...
export class SelectComponent {
  ...
  getLanguage(evt: Event) {
    ...
    console.log('englishData', this.i18nService.getEnglishData);
    console.log('SpanishData', this.i18nService.getSpanishData);
    ...
    if(lang === 'en') {
      ...
      this.translate.setTranslation('fr', this.i18nService.getSpanishData);
